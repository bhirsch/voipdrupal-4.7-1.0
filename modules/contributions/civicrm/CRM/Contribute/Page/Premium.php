...
$GLOBALS['_CRM_CONTRIBUTE_PAGE_PREMIUM']['_links'] =  null;
...
class CRM_Contribute_Page_Premium extends CRM_Core_Page_Basic 
{
    ...
    function &links()
    {            
        if (!($GLOBALS['_CRM_CONTRIBUTE_PAGE_PREMIUM']['_links'])) {
            // helper variable for nicer formatting
            $deleteExtra = ts('Are you sure you want to remove this product form this page?');

            $GLOBALS['_CRM_CONTRIBUTE_PAGE_PREMIUM']['_links'] = array(
        ...
        return $GLOBALS['_CRM_CONTRIBUTE_PAGE_PREMIUM']['_links'];
    ...
    function browse()
    {
        ...
        while ($dao->fetch()) {
            ...
            if ($productDAO->find(true) ) {
                ...
                $premiums[$dao->product_id]['action'] = CRM_Core_Action::formLink(CRM_Contribute_Page_Premium::links(), $action, 
