...
$GLOBALS['_CRM_CONTRIBUTE_PAGE_CONTRIBUTIONPAGE']['_actionLinks'] = null;
...
class CRM_Contribute_Page_ContributionPage extends CRM_Core_Page {
    ...
    function &actionLinks()
    {
        ...
        if (!isset($GLOBALS['_CRM_CONTRIBUTE_PAGE_CONTRIBUTIONPAGE']['_actionLinks'])) {
            ...
            $GLOBALS['_CRM_CONTRIBUTE_PAGE_CONTRIBUTIONPAGE']['_actionLinks'] = array(
        ...
        return $GLOBALS['_CRM_CONTRIBUTE_PAGE_CONTRIBUTIONPAGE']['_actionLinks'];
    }
    ...
    function run()
    {
        ...
        } else if ($action & CRM_CORE_ACTION_UPDATE ) {
    ...
    function browse($action=null)
    {
        ...
        while ($dao->fetch()) {
            ...
            $contribution[$dao->id]['action'] = CRM_Core_Action::formLink(CRM_Contribute_Page_ContributionPage::actionLinks(), $action, 
                                                                          array('id' => $dao->id));
        }
