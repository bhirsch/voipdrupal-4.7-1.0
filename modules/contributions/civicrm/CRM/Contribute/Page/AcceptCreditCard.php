...
$GLOBALS['_CRM_CONTRIBUTE_PAGE_ACCEPTCREDITCARD']['_links'] =  null;
...
class CRM_Contribute_Page_AcceptCreditCard extends CRM_Core_Page_Basic 
{
    ...
    function &links()
    {
        if (!($GLOBALS['_CRM_CONTRIBUTE_PAGE_ACCEPTCREDITCARD']['_links'])) {
            ...
            $GLOBALS['_CRM_CONTRIBUTE_PAGE_ACCEPTCREDITCARD']['_links'] = array(
        ...
        return $GLOBALS['_CRM_CONTRIBUTE_PAGE_ACCEPTCREDITCARD']['_links'];
    }
    ...
    function browse()
    {
        ...
        while ($dao->fetch()) {
            ...
            $acceptCreditCard[$dao->id]['action'] = CRM_Core_Action::formLink(CRM_Contribute_Page_AcceptCreditCard::links(), $action, 
                                                                                    array('id' => $dao->id));
        }
