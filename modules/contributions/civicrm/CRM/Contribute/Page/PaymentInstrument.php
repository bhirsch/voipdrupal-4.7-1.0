...
$GLOBALS['_CRM_CONTRIBUTE_PAGE_PAYMENTINSTRUMENT']['_links'] =  null;
...
class CRM_Contribute_Page_PaymentInstrument extends CRM_Core_Page_Basic 
{
    ...
    function &links()
    {
        if (!($GLOBALS['_CRM_CONTRIBUTE_PAGE_PAYMENTINSTRUMENT']['_links'])) {
            // helper variable for nicer formatting
            $disableExtra = ts('Are you sure you want to disable this Payment Instrument?');

            $GLOBALS['_CRM_CONTRIBUTE_PAGE_PAYMENTINSTRUMENT']['_links'] = array(
        ...
        return $GLOBALS['_CRM_CONTRIBUTE_PAGE_PAYMENTINSTRUMENT']['_links'];
    }
    ...
    function browse()
    {
        ...
        while ($dao->fetch()) {
            ...
            $paymentInstrument[$dao->id]['action'] = CRM_Core_Action::formLink(CRM_Contribute_Page_PaymentInstrument::links(), $action, 
                                                                                    array('id' => $dao->id));
        }
