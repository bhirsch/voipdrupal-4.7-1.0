...
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_MAX_ERRORS',250);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_MAX_WARNINGS',25);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_VALID',1);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_WARNING',2);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_ERROR',4);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_CONFLICT',8);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_STOP',16);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_DUPLICATE',32);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_MULTIPLE_DUPE',64);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_MODE_MAPFIELD',1);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_MODE_PREVIEW',2);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_MODE_SUMMARY',4);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_MODE_IMPORT',8);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_DUPLICATE_SKIP',1);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_DUPLICATE_REPLACE',2);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_DUPLICATE_UPDATE',4);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_DUPLICATE_FILL',8);
define( 'CRM_CONTRIBUTE_IMPORT_PARSER_DUPLICATE_NOCHECK',16);
...
require_once 'CRM/Contribute/Import/Field.php';
 ...
 class CRM_Contribute_Import_Parser {
     ...
     */
    var $_maxWarningCount = CRM_CONTRIBUTE_IMPORT_PARSER_MAX_WARNINGS;
    ...
    function CRM_Contribute_Import_Parser() {
        $this->_maxLinesToProcess = 0;
        $this->_maxErrorCount = CRM_CONTRIBUTE_IMPORT_PARSER_MAX_ERRORS;
    }
    ...
    function run( $fileName,
                  ...
                  $mode = CRM_CONTRIBUTE_IMPORT_PARSER_MODE_PREVIEW,
                  $onDuplicate = CRM_CONTRIBUTE_IMPORT_PARSER_DUPLICATE_SKIP) {
        ...
        while ( ! feof( $fd ) ) {
            ...
            } else if ( $mode == CRM_CONTRIBUTE_IMPORT_PARSER_MODE_PREVIEW) {
                $returnCode = $this->preview( $values );
            } else if ( $mode == CRM_CONTRIBUTE_IMPORT_PARSER_MODE_SUMMARY) {
                $returnCode = $this->summary( $values );
            } else if ( $mode == CRM_CONTRIBUTE_IMPORT_PARSER_MODE_IMPORT) {
    ...
    function setActiveFieldValues( $elements, &$erroneousField ) {    
        ...
        $valid = CRM_CONTRIBUTE_IMPORT_PARSER_VALID;
        for ( $i = 0; $i < $this->_activeFieldCount; $i++ ) {
            if ( ! $this->_activeFields[$i]->validate() ) {
                // no need to do any more validation
                $erroneousField = $i;
                $valid = CRM_CONTRIBUTE_IMPORT_PARSER_ERROR;
                break;
            }
        }
        return $valid;
     ...
     * @access public
     */
    function set( $store, $mode = CRM_CONTRIBUTE_IMPORT_PARSER_MODE_SUMMARY) {
