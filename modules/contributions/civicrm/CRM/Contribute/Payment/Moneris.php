...
define( 'CRM_CONTRIBUTE_PAYMENT_MONERIS_CHARSET','UFT-8');
$GLOBALS['_CRM_CONTRIBUTE_PAYMENT_MONERIS']['_singleton'] =  null;
...
class CRM_Contribute_Payment_Moneris extends CRM_Contribute_Payment { 
     ...
     * @return void 
     */ 
    function CRM_Contribute_Payment_Moneris( $mode ) {
        ...
        if ('CAD' != $config->currencyID) {
          return CRM_Contribute_Payment_Moneris::error(); // Configuration error: default currency must be CAD
        }
    }
     ...
     */ 
     function &singleton( $mode ) {
        if ($GLOBALS['_CRM_CONTRIBUTE_PAYMENT_MONERIS']['_singleton'] === null ) { 
            $GLOBALS['_CRM_CONTRIBUTE_PAYMENT_MONERIS']['_singleton'] =& new CRM_Contribute_Payment_Moneris( $mode );
        } 
        return $GLOBALS['_CRM_CONTRIBUTE_PAYMENT_MONERIS']['_singleton']; 
    } 
