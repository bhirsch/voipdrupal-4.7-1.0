...
define( 'CRM_CONTACT_FORM_DOMAIN_LOCATION_BLOCKS',1);
...
class CRM_Contact_Form_Domain extends CRM_Core_Form {
     ...
     */
     ...
     function postProcess( ) {
        ...
        $location = array();
        for ($locationId = 1; $locationId <= CRM_CONTACT_FORM_DOMAIN_LOCATION_BLOCKS; $locationId++) { // start of for loop for location
