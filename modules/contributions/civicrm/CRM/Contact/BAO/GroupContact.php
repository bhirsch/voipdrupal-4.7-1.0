...
class CRM_Contact_BAO_GroupContact extends CRM_Contact_DAO_GroupContact {
     ...
     * @static
     */
     function addContactsToGroup( &$contactIds, $groupId, $method = 'Admin',$status = 'Added', $tracking = null)  {
     ...
     * @static
     */
     function removeContactsFromGroup( &$contactIds, $groupId ,$method = 'Admin',$status = 'Removed',$tracking = null) {
   ...
   /**
     ...
     function getGroupContacts(&$group, $returnProperties = null, $status = 'Added', $sort = null, $offset = null, $row_count= null)
    {
        ...
        $tables = array(
            CRM_Contact_BAO_GroupContact::getTableName() => true,
