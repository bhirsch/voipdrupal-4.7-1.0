...
class CRM_Contact_BAO_Group extends CRM_Contact_DAO_Group {
     ...
     * @access public
     */
     function memberCount( $id, $status = 'Added' ) {
     ...
     */
     function checkPermission( $id, $title ) {
        if ( CRM_Utils_System::checkPermission( 'edit all contacts' ) ||
             CRM_Utils_System::checkPermission( CRM_CORE_PERMISSION_EDIT_GROUPS . $title ) ) {
            return CRM_CORE_PERMISSION_EDIT;
        }

        if ( CRM_Utils_System::checkPermission( 'view all contacts' ) ||
             CRM_Utils_System::checkPermission( CRM_CORE_PERMISSION_VIEW_GROUPS . $title ) ) {
