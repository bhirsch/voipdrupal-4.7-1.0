...
$GLOBALS['_CRM_CONTACT_SELECTOR_ACTIVITY']['_actionLinks'] = null;
$GLOBALS['_CRM_CONTACT_SELECTOR_ACTIVITY']['_columnHeaders'] = null;
 ...
 *
 */
class CRM_Contact_Selector_Activity extends CRM_Core_Selector_Base {
    /**
     ...
     * @access public
     */
    function CRM_Contact_Selector_Activity($contactId, $permission) 
    {
     ...
     *
     */
     function &actionLinks( $activityType ) 
    {
        $url = '';
        $extra = '';
        ...
        $GLOBALS['_CRM_CONTACT_SELECTOR_ACTIVITY']['_actionLinks'] = array(
        ...
        return $GLOBALS['_CRM_CONTACT_SELECTOR_ACTIVITY']['_actionLinks'];
    }
    ...
    function &getColumnHeaders($action = null, $output = null) 
    {
        if ($output==CRM_CORE_SELECTOR_CONTROLLER_EXPORT || $output==CRM_CORE_SELECTOR_CONTROLLER_SCREEN) {
            ...
            foreach (CRM_Contact_Selector_Activity::_getColumnHeaders() as $column ) {
            ...
            return CRM_Contact_Selector_Activity::_getColumnHeaders();
        }
    }
    ...
    {
        if (!isset($GLOBALS['_CRM_CONTACT_SELECTOR_ACTIVITY']['_columnHeaders'])) {
            $GLOBALS['_CRM_CONTACT_SELECTOR_ACTIVITY']['_columnHeaders'] = array(
        ...
        return $GLOBALS['_CRM_CONTACT_SELECTOR_ACTIVITY']['_columnHeaders'];
    }
}
?>
