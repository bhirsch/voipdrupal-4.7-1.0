...
$GLOBALS['_CRM_CUSTOM_PAGE_OPTION']['_actionLinks'] = null;
...
class CRM_Custom_Page_Option extends CRM_Core_Page {
    ...
    function &actionLinks()
    {
        ...
        if (!isset($GLOBALS['_CRM_CUSTOM_PAGE_OPTION']['_actionLinks'])) {
            // helper variable for nicer formatting
            $disableExtra = ts('Are you sure you want to disable this custom data multiple choice option?');
            $GLOBALS['_CRM_CUSTOM_PAGE_OPTION']['_actionLinks'] = array(
        ...
        return $GLOBALS['_CRM_CUSTOM_PAGE_OPTION']['_actionLinks'];
    }
    ...
    function browse()
    {
	    ...
	    // update enable/disable links depending on custom_field properties.
            ...
            $customOption[$customOptionBAO->id]['action'] = CRM_Core_Action::formLink(CRM_Custom_Page_Option::actionLinks(), $action, 
