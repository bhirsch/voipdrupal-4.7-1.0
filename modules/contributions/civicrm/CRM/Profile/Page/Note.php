...
$GLOBALS['_CRM_PROFILE_PAGE_NOTE']['_links'] =  null;
...
class CRM_Profile_Page_Note extends CRM_Core_Page
{
     ...
     */
     function &links()
    {
        if (!($GLOBALS['_CRM_PROFILE_PAGE_NOTE']['_links'])) {
            $GLOBALS['_CRM_PROFILE_PAGE_NOTE']['_links'] = array(
        ...
        return $GLOBALS['_CRM_PROFILE_PAGE_NOTE']['_links'];
    }
