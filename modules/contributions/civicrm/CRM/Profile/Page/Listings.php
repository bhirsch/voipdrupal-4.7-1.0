...
class CRM_Profile_Page_Listings extends CRM_Core_Page {
    ...
    function preProcess( ) {
        ...
        $this->_fields = CRM_Core_BAO_UFGroup::getListingFields( CRM_CORE_ACTION_UPDATE,
                                                                 CRM_CORE_BAO_UFGROUP_LISTINGS_VISIBILITY, false, $this->_gid );
    ...
    function run( ) {
        ...
        if ( ! CRM_Utils_Array::value( 'reset', $_GET ) || CRM_Utils_Array::value( 'force', $_GET ) ) {
            ...
            $controller =& new CRM_Core_Selector_Controller($selector ,
                                                            ...
                                                            CRM_CORE_ACTION_VIEW, $this, CRM_CORE_SELECTOR_CONTROLLER_TEMPLATE );
        ...
        if ( $this->_search ) {
            $formController =& new CRM_Core_Controller_Simple( 'CRM_Profile_Form_Search', ts('Search Profile'), CRM_CORE_ACTION_ADD );
