...
define( 'CRM_PROFILE_FORM_MODE_REGISTER',1);
define( 'CRM_PROFILE_FORM_MODE_SEARCH',2);
define( 'CRM_PROFILE_FORM_MODE_CREATE',4);
define( 'CRM_PROFILE_FORM_MODE_EDIT',8);
...
class CRM_Profile_Form extends CRM_Core_Form
{
    ...
    { 
        ...
        } else if ( $this->_mode == CRM_PROFILE_FORM_MODE_SEARCH) {
            $this->_fields  = CRM_Core_BAO_UFGroup::getListingFields( $this->_action,
                                                                      CRM_CORE_BAO_UFGROUP_LISTINGS_VISIBILITY, false, $this->_gid ,true); 
        } else {
