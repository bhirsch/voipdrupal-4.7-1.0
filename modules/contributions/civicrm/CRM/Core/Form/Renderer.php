...
$GLOBALS['_CRM_CORE_FORM_RENDERER']['_singleton'] =  null;
...
class CRM_Core_Form_Renderer extends HTML_QuickForm_Renderer_ArraySmarty {
     ...
     * @access public 
     */  
    function CRM_Core_Form_Renderer( ) {
     ...
     */ 
     function &singleton( ) { 
        if ( ! isset( $GLOBALS['_CRM_CORE_FORM_RENDERER']['_singleton'] ) ) { 
            $GLOBALS['_CRM_CORE_FORM_RENDERER']['_singleton'] =& new CRM_Core_Form_Renderer( );
        }
        return $GLOBALS['_CRM_CORE_FORM_RENDERER']['_singleton']; 
    } 
