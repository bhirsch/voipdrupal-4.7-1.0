...
define( 'CRM_CORE_PERMISSION_EDIT_GROUPS','edit contacts in ');
define( 'CRM_CORE_PERMISSION_VIEW_GROUPS','view contacts in ');
define( 'CRM_CORE_PERMISSION_EDIT',1);
define( 'CRM_CORE_PERMISSION_VIEW',2);
