...
$GLOBALS['_CRM_CORE_BAO_ACTIVITYTYPE']['_defaultActivityType'] =  null;
...
class CRM_Core_BAO_ActivityType extends CRM_Core_DAO_ActivityType 
{
     ...
     * class constructor
     */
    function CRM_Core_BAO_ActivityType( ) 
    {
        parent::CRM_Core_DAO_ActivityType( );
    }
