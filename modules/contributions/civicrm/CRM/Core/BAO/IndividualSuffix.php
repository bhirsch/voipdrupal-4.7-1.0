...
$GLOBALS['_CRM_CORE_BAO_INDIVIDUALSUFFIX']['_defaultIndividualSuffix'] =  null;
...
class CRM_Core_BAO_IndividualSuffix extends CRM_Core_DAO_IndividualSuffix {
     ...
     * class constructor
     */
    function CRM_Core_BAO_IndividualSuffix( ) {
        parent::CRM_Core_DAO_IndividualSuffix( );
    }
     ...
     */
     function &getDefault() {
        if ($GLOBALS['_CRM_CORE_BAO_INDIVIDUALSUFFIX']['_defaultIndividualSuffix'] == null) {
            $defaults = array();
            $GLOBALS['_CRM_CORE_BAO_INDIVIDUALSUFFIX']['_defaultIndividualSuffix'] = CRM_Core_BAO_IndividualSuffix::retrieve($params, $defaults);
        }
        return $GLOBALS['_CRM_CORE_BAO_INDIVIDUALSUFFIX']['_defaultIndividualSuffix'];
    }
