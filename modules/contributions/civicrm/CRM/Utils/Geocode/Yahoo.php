 ...
 */
$GLOBALS['_CRM_UTILS_GEOCODE_YAHOO']['_server'] =  'api.local.yahoo.com';
$GLOBALS['_CRM_UTILS_GEOCODE_YAHOO']['_uri'] =  '/MapsService/V1/geocode';
...
class CRM_Utils_Geocode_Yahoo {
     ...
     */
     function format( &$values ) {
        ...
        $args = implode( '&', $arg );
        $query = 'http://' . $GLOBALS['_CRM_UTILS_GEOCODE_YAHOO']['_server'] . $GLOBALS['_CRM_UTILS_GEOCODE_YAHOO']['_uri'] . '?' . $args;
