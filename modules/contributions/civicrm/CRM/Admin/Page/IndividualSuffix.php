...
$GLOBALS['_CRM_ADMIN_PAGE_INDIVIDUALSUFFIX']['_links'] =  null;
...
class CRM_Admin_Page_IndividualSuffix extends CRM_Core_Page_Basic 
{
    ...
    function &links()
    {
        if (!($GLOBALS['_CRM_ADMIN_PAGE_INDIVIDUALSUFFIX']['_links'])) {
            ...
            $GLOBALS['_CRM_ADMIN_PAGE_INDIVIDUALSUFFIX']['_links'] = array(
        ...
        return $GLOBALS['_CRM_ADMIN_PAGE_INDIVIDUALSUFFIX']['_links'];
    }
    ...
    function browse()
    {
        ...
        while ($dao->fetch()) {
            ...
            $individualSuffix[$dao->id]['action'] = CRM_Core_Action::formLink(CRM_Admin_Page_IndividualSuffix::links(), $action, 
                                                                                    array('id' => $dao->id));
        }
