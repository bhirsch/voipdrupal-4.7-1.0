...
$GLOBALS['_CRM_ADMIN_PAGE_INDIVIDUALPREFIX']['_links'] =  null;
...
class CRM_Admin_Page_IndividualPrefix extends CRM_Core_Page_Basic 
{
    ...
    function &links()
    {
        if (!($GLOBALS['_CRM_ADMIN_PAGE_INDIVIDUALPREFIX']['_links'])) {
            ...
            $GLOBALS['_CRM_ADMIN_PAGE_INDIVIDUALPREFIX']['_links'] = array(
        ...
        return $GLOBALS['_CRM_ADMIN_PAGE_INDIVIDUALPREFIX']['_links'];
    }
    ...
    function browse()
    {
        ...
        while ($dao->fetch()) {
            ...
            $individualPrefix[$dao->id]['action'] = CRM_Core_Action::formLink(CRM_Admin_Page_IndividualPrefix::links(), $action, 
                                                                                    array('id' => $dao->id));
        }
