...
$GLOBALS['_CRM_ADMIN_PAGE_DUPEMATCH']['_links'] =  null;
...
class CRM_Admin_Page_DupeMatch extends CRM_Core_Page_Basic 
{
    ...
    function &links()
    {
          if (!($GLOBALS['_CRM_ADMIN_PAGE_DUPEMATCH']['_links'])) {
            // helper variable for nicer formatting
              $GLOBALS['_CRM_ADMIN_PAGE_DUPEMATCH']['_links'] = array(
        ...
        return $GLOBALS['_CRM_ADMIN_PAGE_DUPEMATCH']['_links'];
    }
    ...
    function browse()
    {
        ...
        while ($dao->fetch()) {
            ...
            $dupematch[$dao->id]['action'] = CRM_Core_Action::formLink(CRM_Admin_Page_DupeMatch::links(), $action, 
                                                                                    array('id' => $dao->id));
        }
