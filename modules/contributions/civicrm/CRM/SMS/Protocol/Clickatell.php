...
$GLOBALS['_CRM_SMS_PROTOCOL_CLICKATELL']['_singleton'] =  null;
...
class CRM_SMS_Protocol_Clickatell extends CRM_SMS_Protocol {
     ...
     * @return void
     */
    function CRM_SMS_Protocol_Clickatell( ) {
     ...
     */
     function &singleton( ) {
        if ($GLOBALS['_CRM_SMS_PROTOCOL_CLICKATELL']['_singleton'] === null ) {
            $GLOBALS['_CRM_SMS_PROTOCOL_CLICKATELL']['_singleton'] =& new CRM_SMS_Protocol_Clickatell( );
        }
        return $GLOBALS['_CRM_SMS_PROTOCOL_CLICKATELL']['_singleton'];
    }
