...
$GLOBALS['_CRM_SMS_PROTOCOL']['_singleton'] =  null;
 ...
 */
 ...
 class CRM_SMS_Protocol {
     ...
     */  
     function &singleton( ) {
        if ($GLOBALS['_CRM_SMS_PROTOCOL']['_singleton'] === null ) {
            $config   =& CRM_Core_Config::singleton( );
            
            $classPath = str_replace( '_', '/', $config->smsClass ) . '.php';
            require_once($classPath);
            $GLOBALS['_CRM_SMS_PROTOCOL']['_singleton'] = eval( 'return ' . $config->smsClass . '::singleton( $mode );' );
        }
        return $GLOBALS['_CRM_SMS_PROTOCOL']['_singleton'];
    }
