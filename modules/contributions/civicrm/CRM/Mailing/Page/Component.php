...
$GLOBALS['_CRM_MAILING_PAGE_COMPONENT']['_links'] =  null;
...
class CRM_Mailing_Page_Component extends CRM_Core_Page_Basic {
    ...
    function &links()
    {
        if ( ! ( $GLOBALS['_CRM_MAILING_PAGE_COMPONENT']['_links'] ) ) {

            // helper variable for nicer formatting
            $disableExtra = ts('Are you sure you want to disable this component?');

            $GLOBALS['_CRM_MAILING_PAGE_COMPONENT']['_links'] = array(
        ...
        return $GLOBALS['_CRM_MAILING_PAGE_COMPONENT']['_links'];
    }
