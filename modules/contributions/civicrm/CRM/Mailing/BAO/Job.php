...
$GLOBALS['_CRM_MAILING_BAO_JOB']['translation'] =  null;
...
class CRM_Mailing_BAO_Job extends CRM_Mailing_DAO_Job {
     ...
     * class constructor
     */
    function CRM_Mailing_BAO_Job( ) {
        parent::CRM_Mailing_DAO_Job( );
    }
...
//                 'contact_id'    => $recipient['contact_id']
     ...
     * @static
     */
      function retry($mailing_id, $start_date) {
        $job =& new CRM_Mailing_BAO_Job();
     ...
     */
      function status($status) {
        ...
        if (empty($GLOBALS['_CRM_MAILING_BAO_JOB']['translation'])) {
            $GLOBALS['_CRM_MAILING_BAO_JOB']['translation'] = array(
        ...
        return CRM_Utils_Array::value($status, $GLOBALS['_CRM_MAILING_BAO_JOB']['translation'], ts('Unknown'));
    }
}
