     ...
     */
     function buildQuickForm( ) {
        ...
        $duplicateOptions[] = HTML_QuickForm::createElement('radio',
            null, null, ts('Skip'), CRM_HISTORY_IMPORT_PARSER_DUPLICATE_SKIP);
        $duplicateOptions[] = HTML_QuickForm::createElement('radio',
            null, null, ts('Update'), CRM_HISTORY_IMPORT_PARSER_DUPLICATE_UPDATE);
        $duplicateOptions[] = HTML_QuickForm::createElement('radio',
            null, null, ts('Fill'), CRM_HISTORY_IMPORT_PARSER_DUPLICATE_FILL);
        
        $this->addGroup($duplicateOptions, 'onDuplicate', 
                        ts('On duplicate entries'));
        $this->setDefaults(array('onDuplicate' =>
                                    CRM_HISTORY_IMPORT_PARSER_DUPLICATE_SKIP));
     ...
     */
     function postProcess( ) {
        ...
        $parser->run( $fileName, $seperator,
                      $mapper,
                      $skipColumnHeader,
                      CRM_HISTORY_IMPORT_PARSER_MODE_MAPFIELD);
