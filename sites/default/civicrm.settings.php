...
define( 'CIVICRM_UF_DSN'           , 'mysql://lawrence:lawrence@localhost/lawrence_2006g?new_link=true' );
 ...
 */
global $civicrm_root;
$civicrm_root = '/data/www/lawrence/modules/contributions/civicrm/';
define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/data/www/lawrence/files/civicrm/templates_c/' );
define( 'CIVICRM_UPLOADDIR'          , '/data/www/lawrence/upload/'  );
define( 'CIVICRM_IMAGE_UPLOADDIR'    , '/data/www/lawrence/files/civicrm/persist/');
 ...
 *
 */
define( 'CIVICRM_UF_BASEURL'      , 'http://www.whatsuplawrence.org/' );
define( 'CIVICRM_UF_RESOURCEURL'  , 'http://www.whatsuplawrence.org/modules/contributions/civicrm/' );
define( 'CIVICRM_RESOURCEBASE'    , 'lawrence/modules/contributions/civicrm/' );
define( 'CIVICRM_IMAGE_UPLOADURL' , 'http://www.whatsuplawrence.org/files/civicrm/persist/' );
...
define( 'CIVICRM_DSN'          , 'mysql://lawrence:lawrence@localhost/lawrence_2006g?new_link=true' );
define( 'CIVICRM_MYSQL_PATH', '/usr/bin/' );
...
define('CIVICRM_MAP_API_KEY'  , 'ABQIAAAA1zAZsydc57MaIRseeJ2nghRZawOaurVN-0F9khn1NjV5-n2f3hQQcHQNG0QaD5xtf88KDDriRv7Kgg' );
