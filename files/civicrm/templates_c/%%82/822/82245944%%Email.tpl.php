<?php /* Smarty version 2.6.12-dev, created on 2006-07-10 13:58:02
         compiled from CRM/Contact/Form/Email.tpl */ ?>
    ...
    <div class="form-item">
        <span class="labels">
            <?php echo $this->_tpl_vars['form']['location'][$this->_tpl_vars['index']]['email']['1']['email']['label']; ?>

        </span>
        <span class="fields">
            <?php echo $this->_tpl_vars['form']['location'][$this->_tpl_vars['index']]['email']['1']['email']['html']; ?>

            <!-- Link to add a field.-->
            <span id="location[<?php echo $this->_tpl_vars['index']; ?>
][email][2][show]" class="add-remove-link">
                <?php echo $this->_tpl_vars['form']['location'][$this->_tpl_vars['index']]['email']['2']['show']['html']; ?>
...
?>
       <?php $this->assign('innerIndex', $this->_sections['innerLoop']['index']); ?>
        ...
        <!-- Email block <?php echo $this->_tpl_vars['innerIndex']; ?>
.-->
        <div id="location[<?php echo $this->_tpl_vars['index']; ?>
][email][<?php echo $this->_tpl_vars['innerIndex']; ?>
]" class="form-item">
            <span class="labels">
             <?php echo $this->_tpl_vars['form']['location'][$this->_tpl_vars['index']]['email'][$this->_tpl_vars['innerIndex']]['email']['label']; ?>

            </span>
            <span class="fields">
              <span><?php echo $this->_tpl_vars['form']['location'][$this->_tpl_vars['index']]['email'][$this->_tpl_vars['innerIndex']]['email']['html']; ?>
</span>
              <!-- Link to hide this field -->
              <span id="location[<?php echo $this->_tpl_vars['index']; ?>
][email][<?php echo $this->_tpl_vars['innerIndex']; ?>
][hide]" class="add-remove-link element-right">
              <?php echo $this->_tpl_vars['form']['location'][$this->_tpl_vars['index']]['email'][$this->_tpl_vars['innerIndex']]['hide']['html']; ?>
              ...
              <?php if ($this->_tpl_vars['innerIndex'] < $this->_tpl_vars['blockCount']): ?>
                ...
                <span id="location[<?php echo $this->_tpl_vars['index']; ?>
][email][<?php echo $this->_tpl_vars['j']; ?>
][show]" class="add-remove-link">
                    <?php echo $this->_tpl_vars['form']['location'][$this->_tpl_vars['index']]['email'][$this->_tpl_vars['j']]['show']['html']; ?>
