<?php /* Smarty version 2.6.12-dev, created on 2006-07-10 13:58:02
         compiled from CRM/Contact/Form/Address/supplemental_address_1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Contact/Form/Address/supplemental_address_1.tpl', 9, false),)), $this); ?>
<div class="form-item">
    <span class="labels">
    <?php echo $this->_tpl_vars['form']['location'][$this->_tpl_vars['index']]['address']['supplemental_address_1']['label']; ?>

    </span>
    <span class="fields">
    <?php echo $this->_tpl_vars['form']['location'][$this->_tpl_vars['index']]['address']['supplemental_address_1']['html']; ?>
